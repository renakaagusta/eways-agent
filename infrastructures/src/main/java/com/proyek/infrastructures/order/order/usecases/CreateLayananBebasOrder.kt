...
class CreateLayananBebasOrder: ViewModel() {
    ...
    fun set(name: String, description: String, serviceId: String, customerName: String, customerAddress: String, customerPhoneNumber: String, customerCluster: String, agentId: String, context: Context) {
        MyRetrofit
            .createService(services)
            .createLayananBebasOrder(name, description, serviceId, customerName, customerAddress, customerPhoneNumber, customerCluster, agentId)
