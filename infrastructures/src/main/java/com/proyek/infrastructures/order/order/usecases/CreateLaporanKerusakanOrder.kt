...
class CreateLaporanKerusakanOrder: ViewModel() {
    private val services = OrderApiServices::class.java
    private val result = MutableLiveData<OrderResponse>()

    fun set(laporanKerusakanBody: LaporanKerusakanBody, context: Context) {
        MyRetrofit
            .createService(services)
            .createLaporKerusakanOrder(laporanKerusakanBody)
