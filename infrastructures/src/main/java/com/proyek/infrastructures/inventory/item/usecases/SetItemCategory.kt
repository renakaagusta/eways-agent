...
class SetItemCategory: ViewModel() {
    private val services = ItemApiServices::class.java
    private val result = MutableLiveData<ItemResponse>()

    internal fun set(name: String,description: String,price: Int, photoPath: String, category: Category, context: Context) {
        MyRetrofit
            .createService(services)
            .setItemCategory(name, description, price, photoPath, category)
