package com.eways.agent.order.activity.getcustomer.adapter.option
...
class InternetServicePacketOptionAdapter(private var itemList: ArrayList<InternetServiceOptionViewDTO>): RecyclerView.Adapter<InternetServicePacketOptionAdapter.OptionViewHolder>(), Filterable {
