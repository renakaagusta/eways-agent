...
import kotlinx.android.synthetic.main.activity_pickupticket_onrequest.*
import kotlinx.android.synthetic.main.activity_pickupticket_onrequest.imgProfile
import kotlinx.android.synthetic.main.activity_pickupticket_onrequest.tvAccept
import kotlinx.android.synthetic.main.activity_pickupticket_onrequest.tvCustomerAddress
import kotlinx.android.synthetic.main.activity_pickupticket_onrequest.tvCustomerCluster
import kotlinx.android.synthetic.main.activity_pickupticket_onrequest.tvCustomerName
import kotlinx.android.synthetic.main.activity_pickupticket_onrequest.tvCustomerPhone
import kotlinx.android.synthetic.main.activity_pickupticket_onrequest.tvDate
import kotlinx.android.synthetic.main.activity_pickupticket_onrequest.tvServicePacketName
...
class PickupTicketOnRequestActivity :BaseActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_pickupticket_onrequest)
    ...
    private fun setData(lifecycleOwner: LifecycleOwner){
        ...
        this@PickupTicketOnRequestActivity.showProgress()
        ...
        GlobalScope.launch(Dispatchers.Main) {
            ...
            getOrderDetail.set(this@PickupTicketOnRequestActivity,orderId)
            delay(500)
            ...
            getCustomerDetail.set(customerId, this@PickupTicketOnRequestActivity)
            delay(1000)
            getCustomerDetail.get().observe(lifecycleOwner, Observer {
                ...
                if(it.data[0].imagePath!=null)
                    Glide.with(this@PickupTicketOnRequestActivity)
            ...
            this@PickupTicketOnRequestActivity.dismissProgress()
        }
    }

    fun moveToMainActivity() {
        val intent = Intent(this@PickupTicketOnRequestActivity, MainActivity::class.java)
    ...
    private fun acceptOrder(){
        tvAccept.setOnClickListener {
            ...
            acceptOrder.set(orderId, this@PickupTicketOnRequestActivity)
                ...
                if(it.errors.message?.isEmpty()!!) {
                    GlobalScope.launch(Dispatchers.Main) {
                        createNotification.set(
                            ...
                            orderId,
                            user.username!!,
                            "Order Laporan Kerusakan mu telah dikonfirmasi oleh Agen",
                            this@PickupTicketOnRequestActivity
                        )
                        delay(300)
                        createNotification.set(
                            user.ID!!,
                        ...
                        setConfirm(this@PickupTicketOnRequestActivity::moveToMainActivity)
                    }
                } else {
                    this@PickupTicketOnRequestActivity.dismissProgress()
                    this@PickupTicketOnRequestActivity.showError(it.errors.message!![0])
                }
            })
        }
    }
