...
import com.eways.agent.order.viewdto.SubProductViewDTO
import kotlinx.android.synthetic.main.row_subproduct.view.*
import java.util.*
import kotlin.collections.ArrayList


class SubProductAdapter(private val subProducts : MutableList<SubProductViewDTO>) : RecyclerView.Adapter<SubProductAdapter.SubproductViewHolder>(),
    Filterable {
