...
class ServicePacketOptionAdapter(private var itemList: MutableList<String>): RecyclerView.Adapter<ServicePacketOptionAdapter.OptionViewHolder>(),
    Filterable {
    ...
    inner class OptionViewHolder (view: View) : RecyclerView.ViewHolder(view) {
        fun bindOption(string: String) {
            itemView.apply {
                ...
                setOnClickListener {
                    val intent = Intent()
                    intent.putExtra("service_packet", string)
