...
import kotlinx.android.synthetic.main.activity_gantipaket_isdone.tvAgentFee
import kotlinx.android.synthetic.main.activity_gantipaket_isdone.tvCustomerAddress
import kotlinx.android.synthetic.main.activity_gantipaket_isdone.tvCustomerCluster
import kotlinx.android.synthetic.main.activity_gantipaket_isdone.tvCustomerName
import kotlinx.android.synthetic.main.activity_gantipaket_isdone.tvCustomerPhone
import kotlinx.android.synthetic.main.activity_gantipaket_isdone.tvDate
import kotlinx.android.synthetic.main.activity_gantipaket_isdone.tvServicePacketName
import kotlinx.android.synthetic.main.activity_gantipaket_isdone.tvTotal
...
class GantiPaketIsDoneActivity : BaseActivity() {
    ...
    override fun onStart() {
        ...
        finishedOrder = ViewModelProvider(
            this,
            ViewModelProvider.NewInstanceFactory()
        ).get(AgentFinishOrder::class.java)
    ...
    private fun setData(lifecycleOwner: LifecycleOwner) {
        ...
        GlobalScope.launch(Dispatchers.Main) {
            ...
            getOrderDetail.set(this@GantiPaketIsDoneActivity,orderId)
            delay(500)
            ...
            if(customerId!=user.ID) {
                getCustomerDetail.set(customerId, this@GantiPaketIsDoneActivity)
                delay(1000)
                getCustomerDetail.get().observe(lifecycleOwner, Observer {
                    ...
                    if (it.data[0].imagePath != null)
                        Glide.with(this@GantiPaketIsDoneActivity)
